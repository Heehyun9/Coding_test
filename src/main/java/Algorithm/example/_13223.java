...
public class _13223 {
    public static void main(String[] args) {
        ...
        String[] currentDrop = drop.split(":");
        int dropHour = Integer.parseInt(currentDrop[0]);
        int dropMinute = Integer.parseInt(currentDrop[1]);
        int dropSecond = Integer.parseInt(currentDrop[2]);
